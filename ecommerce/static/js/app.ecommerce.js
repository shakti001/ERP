app.config(function($stateProvider){
  ...
  .state('businessManagement.ecommerce.client', {
    url: "/client",
    templateUrl: '/static/ngTemplates/app.ecommerce.client.html',
    controller: 'businessManagement.ecommerce.client'
  })
  .state('businessManagement.ecommerce.todo', {
    url: "/todo",
    templateUrl: '/static/ngTemplates/app.ecommerce.todo.html',
    controller: 'businessManagement.ecommerce.todo'
  })
